...
class ViewController: UIViewController, UITableViewDataSource,UITableViewDelegate {
    ...
    ***************************************************/
    ...
    var myFavoriteMovies = ["Avatar", "Alien", "Aliens", "Star Wars: The Empire Strikes Back"]
    ...
    ***************************************************/
    ...
    @IBAction func onStretch1Pressed(_ sender: UIButton) {
        ...
        ***************************************************/
        ...
        myFavoriteMovies.append("Star Wars: Return of the Jedi")
        myFavoriteMovies.insert("Star Wars: A New Hope", at: 3)
